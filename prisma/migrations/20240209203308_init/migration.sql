-- CreateEnum
CREATE TYPE "UPDATE_STATUS" AS ENUM ('IN_PROGRESS', 'SHIPPED', 'DEPRACATED');
...
-- AddForeignKey
ALTER TABLE "updatePoints" ADD CONSTRAINT "updatePoints_UpdatetId_fkey" FOREIGN KEY ("UpdatetId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
